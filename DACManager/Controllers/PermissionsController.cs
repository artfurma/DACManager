...
namespace DACManager.Controllers
{
	public class PermissionsController : Controller
	{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,User,Actors,Movies,Categories,Customers,Inventories,Languages,Payments,Permissions,Rentals,Staff,Stores,Receive,Transfer,LastUpdate")] Permission permission)
		{
			if (id != permission.Id)
			{
				return NotFound();
