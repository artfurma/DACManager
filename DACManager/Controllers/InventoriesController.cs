...
namespace DACManager.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StoreId")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StoreId")] Inventory inventory)
        {
            if (id != inventory.Id)
            {
                return NotFound();
